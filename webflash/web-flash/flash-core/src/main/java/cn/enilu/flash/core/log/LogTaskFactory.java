...
public class LogTaskFactory {
    ...
    public static TimerTask loginLog_f(final Long userId, final String msg, final String ip) {
        return new TimerTask() {
            @Override
            public void run() {
                try {
                    LoginLog loginLog = LogFactory.createLoginLog(LogType.LOGIN_FAIL, userId, msg, ip);
                    loginLogRepository.save(loginLog);
                } catch (Exception e) {
