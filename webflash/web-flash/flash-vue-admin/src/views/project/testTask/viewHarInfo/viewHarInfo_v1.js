...
export default {
    ...
    props: {
        json1: {
            'url': {
                'request': {
                    'method': 'POST',
                    'url': 'http://133.133.135.182:32677/api/v1/travelservice/trips/left',
                    ...
                    'response': {
                        ...
                        'content': {
                            'text':
                                { 'status': 1,
                                    'msg': 'Success',
                                    'data': [{ 'tripId': { 'type': 'D', 'number': 1345 }, 'trainTypeId': 'DongCheOne' }] },
                            'comment': ''
                        }
                    }
                }
                    ...
                    'response': {
                        ...
                        'content': {
                            'text':
                                { 'status': 1,
                                    'msg': 'Success',
                                    'data': [{ 'tripId': { 'type': 'url2-tripID-type', 'number': 'url2-tripID-number' }, 'trainTypeId': 'url2-tripID-trainTypeId' }] },
                            'comment': ''
                        }
                    }
                }
                    ...
                    'response': {
                        ...
                        'content': {
                            'text':
                                { 'status': 1,
                                    'msg': 'Success',
                                    'data': [{ 'tripId': { 'type': 'url1-tripID-type', 'number': 'url1-tripID-number' }, 'trainTypeId': 'url1-tripID-trainTypeId' }] },
                            'comment': ''
                        }
                    }
                }
    ...
    methods: {
        ...
        toggleJson1() {
            this.showJson1 = !this.showJson1
        },
        toggleJson2() {
            this.showJson2 = !this.showJson2
        },
