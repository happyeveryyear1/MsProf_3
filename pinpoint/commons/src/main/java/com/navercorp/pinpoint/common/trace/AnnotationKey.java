...
//    API_ID(11, "API-ID"),
    ...
    // task_id, test_id and my_token
    AnnotationKey HTTP_TEST_ID = AnnotationKeyFactory.of(901, "http.test.id", VIEW_IN_RECORD_SET);
    AnnotationKey HTTP_TASK_ID = AnnotationKeyFactory.of(902, "http.task.id", VIEW_IN_RECORD_SET);
    AnnotationKey HTTP_MY_TOKEN = AnnotationKeyFactory.of(903, "http.my_token", VIEW_IN_RECORD_SET);
    AnnotationKey HTTP_TOOL_TYPE = AnnotationKeyFactory.of(905, "http.tool_type", VIEW_IN_RECORD_SET);
