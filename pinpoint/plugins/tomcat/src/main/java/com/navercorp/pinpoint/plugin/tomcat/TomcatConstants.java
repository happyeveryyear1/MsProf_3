...
public final class TomcatConstants {
    ...
    public static final AnnotationKey TOMCAT_SOCKET_PROCESS_TIME = AnnotationKeyFactory.of(904, "TOMCAT_SOCKET_PROCESS_TIME", com.navercorp.pinpoint.common.trace.AnnotationKeyProperty.VIEW_IN_RECORD_SET);
