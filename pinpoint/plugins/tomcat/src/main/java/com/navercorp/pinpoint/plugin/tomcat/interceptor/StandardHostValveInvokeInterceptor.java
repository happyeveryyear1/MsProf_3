...
public class StandardHostValveInvokeInterceptor implements AroundInterceptor {
    ...
    public void after(Object target, Object[] args, Object result, Throwable throwable) {
        ...
        // 记录Tomcat Socket Process 时间
        Trace trace = traceContext.currentTraceObject();
        if (trace != null) {
            SpanEventRecorder recorder = trace.currentSpanEventRecorder();
            recorder.recordAttribute(TomcatConstants.TOMCAT_SOCKET_PROCESS_TIME, NioSocketProcessorInterceptor.localSocketProcessTime.get());
        }
        NioSocketProcessorInterceptor.localSocketProcessTime.remove();
